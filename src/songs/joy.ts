...
export const joySong: SongDef = {
  ...
  events: [
    ...
    { beat: 18, object: 'joy_17', note: 'E5', lyric: "Hearts", section: 1 },
    { beat: 19, object: 'joy_18', note: 'E5', lyric: "un", section: 1 },
    { beat: 20, object: 'joy_19', note: 'F5', lyric: "fold", section: 1 },
    { beat: 21, object: 'joy_20', note: 'G5', lyric: "like", section: 1 },
    { beat: 22, object: 'joy_21', note: 'G5', lyric: "flow'rs", section: 1 },
    { beat: 23, object: 'joy_22', note: 'F5', lyric: "be", section: 1 },
    { beat: 24, object: 'joy_23', note: 'E5', lyric: "fore", section: 1 },
    { beat: 25, object: 'joy_24', note: 'D5', lyric: "thee", section: 1 },
    { beat: 26, object: 'joy_25', note: 'C5', lyric: "hail", section: 1 },
    { beat: 27, object: 'joy_26', note: 'C5', lyric: "thee", section: 1 },
    { beat: 28, object: 'joy_27', note: 'D5', lyric: "as", section: 1 },
    { beat: 29, object: 'joy_28', note: 'E5', lyric: "the", section: 1 },
    { beat: 30, object: 'joy_29', note: 'D5', lyric: "sun", section: 1 },
    { beat: 31, object: 'joy_30', note: 'C5', lyric: "a", section: 1 },
    { beat: 32, object: 'joy_31', note: 'C5', lyric: "bove", section: 1 },
  ],
};
