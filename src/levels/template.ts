...
export const environmentPresets: Record<string, NonNullable<LevelFile['environment']>> = {
  Daylight: { 'board': '#5b5970', 'background': '#2e2d38', 'keyLight': '#fff0d8', 'keyIntensity': 2.0, 'keyRake': 0.3, 'fill': '#c9c3ff', 'fillIntensity': 0.3, 'rim': '#b9c9ff', 'rimIntensity': 0.5, 'metal': '#c3c7d1', 'wood': '#9a4a2e', 'ring': '#f5c542', 'envIntensity': 0.25, 'exposure': 0.9, 'vignette': 0.4, 'padGlow': 0.0, 'padLight': 0.0, 'boardGrain': 0.25, 'shaft': 0.45, 'shaftColor': '#ffe9c4', 'shaftAngle': 24 },
  Neon: { 'board': '#2a2924', 'background': '#0a0a0c', 'keyLight': '#ffe9c8', 'keyIntensity': 1.5, 'keyRake': 0.6, 'fill': '#4a4670', 'fillIntensity': 0.5, 'rim': '#4d6fa8', 'rimIntensity': 0.4, 'metal': '#7f8aa8', 'wood': '#3f2a52', 'ring': '#ffd84a', 'envIntensity': 0.18, 'exposure': 1.0, 'vignette': 0.5, 'padGlow': 0.55, 'padLight': 4, 'boardGrain': 0.7, 'shaft': 0.85, 'shaftColor': '#ffd9a3', 'shaftAngle': 26 },
  Workshop: { 'board': '#c9bba3', 'background': '#8f836f', 'keyLight': '#fff0d0', 'keyIntensity': 2.4, 'keyRake': 0.35, 'fill': '#efe2cc', 'fillIntensity': 0.4, 'rim': '#ffe9c4', 'rimIntensity': 0.5, 'metal': '#5f636e', 'wood': '#7a4a2a', 'ring': '#e0533d', 'envIntensity': 0.45, 'exposure': 0.95, 'vignette': 0.45, 'padGlow': 0, 'padLight': 0, 'boardGrain': 0.35, 'shaft': 0.55, 'shaftColor': '#fff0cf', 'shaftAngle': 22 },
  Slate: { 'board': '#3a3f47', 'background': '#181b20', 'keyLight': '#e8f0ff', 'keyIntensity': 2.2, 'keyRake': 0.5, 'fill': '#7d8fa8', 'fillIntensity': 0.4, 'rim': '#ffd9a8', 'rimIntensity': 0.6, 'metal': '#d0d5de', 'wood': '#a3552f', 'ring': '#ffd84a', 'envIntensity': 0.35, 'exposure': 1.0, 'vignette': 0.45, 'padGlow': 0.3, 'padLight': 4, 'boardGrain': 0.5, 'shaft': 0.8, 'shaftColor': '#d8e6ff', 'shaftAngle': 20 },
};
